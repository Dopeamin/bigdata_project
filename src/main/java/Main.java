...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        getMostCommonValues(data);

        // Get most common values for each field per country
        getMostCommonValuesByCountry(data);
    }
    ...
    private static Map<String, Map<String, Integer>> groupDataByField(List<String[]> data) {
    ...
    private static Map<String, Map<String, Map<String, Integer>>> groupDataByCountryAndField(List<String[]> data) {
